...
public class PongServer {
	...
	public PongServer() throws IOException
	{
		...
		while (player2 == null)
		{
			...
			if (player1 == null)
			{
				player1 = new PongClientHandler(_s, _s.getInputStream(), _s.getOutputStream(), 1, protocol);
			...
			{
				player2 = new PongClientHandler(_s, _s.getInputStream(), _s.getOutputStream(), 2, protocol);
				Thread thread = new Thread(player1);
				thread.start();
				System.out.println("Player2 connected");
				player2.OutputStream.writeUTF("PLAYER;YOU;1");
				player2.OutputStream.writeUTF("PLAYER;YOU;0");
			}
		}
